window.exparser.registerBehavior({
    ...
    handleLabelTap: function (e) {
        this.disabled || (this.checked2 = !this.checked2)
    },
    onInputChange: function (e) {

        return this.checked2 = !this.checked2, this.disabled ? void(this.checked2 = !this.checked2) : void this.$emit("bindchange", {detail:{value: this.checked2}}, !0)
    },
