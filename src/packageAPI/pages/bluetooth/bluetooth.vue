    ...
    <onekit-view class="container">
      <onekit-view class="page-body">
        <onekit-view class="page-section">
          <onekit-view class="page-body-info">
            ...
            <onekit-scroll-view class="device_list" scroll-y scroll-with-animation>
              ...
              >
                ...
                >信号强度: {{item.RSSI}}dBm ({{utils.max(0, item.RSSI + 100)}}%)</onekit-view>
                <onekit-view style="font-size: 10px">UUID: {{item.deviceId}}</onekit-view>
                <onekit-view
                  style="font-size: 10px"
                >Service数量: {{utils.len(item.advertisServiceUUIDs)}}</onekit-view>
              </onekit-view>
            </onekit-scroll-view>
          </onekit-view>
          ...
          <onekit-view class="btn-area">
            <onekit-button type="primary" @:tap="changeMode">进去从机模式</onekit-button>
          </onekit-view>
        </onekit-view>
      </onekit-view>
