  ...
  <page>
    ...
    <onekit-view class="container">
      <onekit-block v-if="support">
        <onekit-button type="primary" @:tap="getPerformanceInfo">获取性能数据</onekit-button>
        <onekit-view class="page-section">
          <onekit-view v-for="item in array" class="performance-list" :key="item">
      ...
      <onekit-view style="text-align: center" v-else>微信版本过低，暂不支持本功能</onekit-view>
    </onekit-view>
  </page>
</template>
<script>
