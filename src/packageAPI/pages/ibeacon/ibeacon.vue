        ...
        <onekit-view class="page-body-info">
          ...
          <onekit-scroll-view class="device_list" scroll-y scroll-with-animation>
            <onekit-view
              ...
              :key="item.index"
            >
              <onekit-view style="font-size: 16px; color: #333;">
                主ID: {{item.major}}
                <onekit-text style="font-size: 12px;">次ID: {{item.minor}}</onekit-text>
              </onekit-view>
              ...
              >Proximity: {{item.proximity}} Accuracy: {{item.accuracy}}</onekit-view>
            </onekit-view>
          </onekit-scroll-view>
        </onekit-view>
      </onekit-view>
