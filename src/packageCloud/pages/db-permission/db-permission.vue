          ...
          <onekit-view class="weui-cells weui-cells_after-title">
            <onekit-view class="weui-cell weui-cell_select">
              ...
              <onekit-view class="weui-cell__bd">
                ...
                >
                  <onekit-view
                    class="weui-select permission-select"
                    weui-select_in-select-after
                  >{{permissions[currentPermissionIndex]}}</onekit-view>
                </onekit-picker>
              </onekit-view>
            </onekit-view>
          </onekit-view>
              ...
              <onekit-block v-if="currentPermissionIndex === 0">
                <onekit-view class="weui-tab">
                  <onekit-view class="weui-navbar">
                    <onekit-block v-for="item in tabs[currentPermissionIndex]" :key="item">
                      <onekit-view
                        :id="index"
                        :class="'weui-navbar__item '+activeTabIndex === index ? 'weui-bar__item_on' : ''"
                        @tap="onTabClick"
                      >
    ...
    wx.getSystemInfo({
      success: function (res) {
        that.setData({
          ...
          sliderOffset:
            (res.windowWidth / tabLength) * that.data.activeTabIndex,
        });
      },
    });
  },
