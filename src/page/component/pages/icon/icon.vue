...
<onekit-view class="container">
  ...
  <onekit-view class="icon-box">
    ...
    <onekit-view class="icon-box-ctn">
      ...
      <onekit-view class="icon-box-desc">用于多选控件中，表示已选择该项目</onekit-view>
    </onekit-view>
  </onekit-view>
  <onekit-view class="icon-box">
    <onekit-view class="icon-small-wrp">
    ...
    <onekit-view class="icon-box-ctn">
      ...
      <onekit-view class="icon-box-desc">用于多选控件中，表示该项目可被选择，但还未选择</onekit-view>
    </onekit-view>
  </onekit-view>
  <onekit-view class="icon-box">
    <onekit-view class="icon-small-wrp">
    ...
    <onekit-view class="icon-box-ctn">
      ...
      <onekit-view class="icon-box-desc">用于在表单中表示出现错误</onekit-view>
    </onekit-view>
  </onekit-view>
  <onekit-view class="icon-box">
    <onekit-view class="icon-small-wrp">
    ...
    <onekit-view class="icon-box-ctn">
      ...
      <onekit-view class="icon-box-desc">用于单选控件中，表示已选择该项目</onekit-view>
    </onekit-view>
  </onekit-view>
  <onekit-view class="icon-box">
    <onekit-view class="icon-small-wrp">
    ...
    <onekit-view class="icon-box-ctn">
      ...
      <onekit-view class="icon-box-desc">用于表示可下载</onekit-view>
    </onekit-view>
  </onekit-view>
  <onekit-view class="icon-box">
    <onekit-view class="icon-small-wrp">
    ...
    <onekit-view class="icon-box-ctn">
      <onekit-view class="icon-box-title">提示</onekit-view>
      <onekit-view class="icon-box-desc">用于在表单中表示有信息提示</onekit-view>
    </onekit-view>
  </onekit-view>
  <onekit-view class="icon-box">
    <onekit-view class="icon-small-wrp">
    ...
    <onekit-view class="icon-box-ctn">
      ...
      <onekit-view class="icon-box-desc">用于在表单中，表示关闭或停止</onekit-view>
    </onekit-view>
  </onekit-view>
  <onekit-view class="icon-box">
    <onekit-view class="icon-small-wrp">
    ...
    <onekit-view class="icon-box-ctn">
      ...
      <onekit-view class="icon-box-desc">用于搜索控件中，表示可搜索</onekit-view>
    </onekit-view>
  </onekit-view>
