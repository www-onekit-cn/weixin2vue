...
<onekit-view class="toolbar"null :hidden="false" :style="'bottom: '+isIOS ? keyboardHeight : 0+'px; height: '+toolBarHeight+'px; padding-bottom: '+isIOS ? safeHeight : 0+'px'">
	<onekit-i class="iconfont icon-charutupian"null></onekit-i>
