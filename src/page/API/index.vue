<template>
  <onekit-page id='app'>
    <onekit-set-tab-bar v-if="isSetTabBarPage"
                        @unmount="leaveSetTabBarPage"></onekit-set-tab-bar>
    <onekit-view v-else
                 onekit-class="index">
      <onekit-view onekit-class="index-hd">
        <onekit-image onekit-class="index-logo"
                      src="resources/kind/logo.png"></onekit-image>
        <onekit-view onekit-class="index-desc">以下将演示小程序接口能力，具体属性参数详见 <onekit-navigator url="pages/doc-web-view/doc-web-view"
              ...
              <onekit-view :onekit-class="'kind-list-item-bd '+(item.open ? 'kind-list-item-bd-show' : '')">
                <onekit-view :onekit-class="'navigator-box '+(item.open ? 'navigator-box-show' : '')">
                  <template v-for="(page) in item.pages">
                    <onekit-navigator :url="'../../packageAPI/pages/'+(page.url)"
